		...
		<View style={styles.container}>
			<Placeholder Animation={PlaceholderAnimation}>
				...
				<View style={styles.infoPlaceholder}>
					<PlaceholderLine noMargin color={theme.placeholder} style={styles.namePlaceholder} width={70} height={20} />
					<PlaceholderLine noMargin color={theme.placeholder} style={styles.handlePlaceholder} width={50} height={16} />
					{viewMode && (
						<View style={styles.interact}>
							<PlaceholderLine noMargin color={theme.placeholder} style={styles.interaction} width={48} height={32} />
							<PlaceholderLine noMargin color={theme.placeholder} style={styles.interaction} width={48} height={32} />
						</View>
					)}
					<PlaceholderLine
